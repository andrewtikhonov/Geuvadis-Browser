    ...
    linkedToATable : function (feature, linked) {
        ...
        while(i--) {
            ...
            string0 = string0 +
                ...
                "<td>" + '<a href="javascript:this.genoverseBrowser.startDragScroll(null);this.genoverseBrowser.setChrAndRange(' +
                    feature.chr + ',' + linkedStart + ',' + linkedEnd + ',true,true);this.genoverseBrowser.stopDragScroll(null, true)">' +
